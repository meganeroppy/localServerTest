...
namespace Dissonance.Networking.Client
{
        ...
        where TPeer : struct
    {
        ...
        private void OnPlayerJoined([NotNull] string name)
        {
        ...
        public void Send(ArraySegment<byte> encodedAudio)
        {
            ...
            if (Log.AssertAndLogWarn(_session.LocalId.HasValue, "Attempted to send voice before assigned a client ID by the host"))
                return;
