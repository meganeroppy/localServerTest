...
namespace Dissonance
{
        ...
        : VoicePlayerState
    {
        ...
        public override float Amplitude
        {
            get
            {
                return _micAmplitude == null ? 0 : _micAmplitude.Amplitude;
            }
        }
        ...
        public override void GetSpeakingChannels(List<RemoteChannel> channels)
        {
            ...
            using (var enumerator = _roomChannels.GetEnumerator())
                while (enumerator.MoveNext())
                    channels.Add(CreateRemoteChannel(enumerator.Current.Value));
        ...
        private static RemoteChannel CreateRemoteChannel<T>([NotNull] T item)
